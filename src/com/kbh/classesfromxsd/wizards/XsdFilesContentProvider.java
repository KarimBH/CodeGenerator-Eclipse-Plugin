...
public class XsdFilesContentProvider implements ITreeContentProvider {
...
//		
//		String[] xsdFilePAths= ((File) arg0).list(new FilenameFilter() {
//			public boolean accept(File directory, String fileName) {
//				return fileName.endsWith(".xsd");
//			}
//		});
//		for (int i = 0; i < xsdFilePAths.length; i++) {
//			xsdFiles.add(new File(xsdFilePAths[i]));
//		}
//		return xsdFiles.toArray();
	...
	public Object[] getElements(Object arg0) {
		...
		return getChildren(new File((String) arg0));
	}
